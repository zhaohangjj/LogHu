...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '上网是一个生活技能', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'zhaohang', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://loghu.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'zhaohang, 博客', // 网站关键词 英文逗号隔开
